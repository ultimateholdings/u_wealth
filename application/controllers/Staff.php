...
class Staff extends MY_Controller
{
    ...
    public function edit_des($id)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $perm = array(
                ...
                'bank_compliance'        => $this->input->post('bank_compliance') ? $this->input->post('bank_compliance') : '0',
                'invoice'        => $this->input->post('invoice') ? $this->input->post('invoice') : '0',
                'manage_news'    => $this->input->post('manage_news') ? $this->input->post('manage_news') : '0',
                'manage_rewards'  => $this->input->post('manage_rewards') ? $this->input->post('manage_rewards') : '0',
                'manage_reports'   => $this->input->post('manage_reports') ? $this->input->post('manage_reports') : '0',
                'manage_kyc'   => $this->input->post('manage_kyc') ? $this->input->post('manage_kyc') : '0',
                'recharge_portal'   => $this->input->post('recharge_portal') ? $this->input->post('recharge_portal') : '0',
    ...
    public function designations()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->db->select('id, des_title, payscale');
            $this->db->limit($config['per_page'], $page);
            $data['result_staff']     = $this->db->get('staff_designation')->result();

            $data['title']      = 'Add Roles';
            $data['breadcrumb'] = 'Add Roles';
