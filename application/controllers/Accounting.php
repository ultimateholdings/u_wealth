...
class Accounting extends MY_Controller
{
     ...
     * Accounting Controller for Admin 
    ...
    */
    ...
    /**
     * Function to add Manual Invoice from Admin
     *
     * @param invoice_name  Invoice Name 
     * @param user_id       User Id
     * @param invoice_date  Invoice Date
     * @param user_type     User Type (Distributor, Customer)
     * @param company_add   Company Address
     * @param bill_add      Billing Address
     * @param total_amt     Total Amount
     * @param paid_amt      Customer Paid Amount
