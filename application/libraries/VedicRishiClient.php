...
{
   private $userId = "615555";
   private $apiKey = "ad35068d61761c64853d80a1fe83627b";
  // private $language = "Kannada";

   function __construct()
    {
        // Assign by reference with "&" so we don't create a copy
        $this->CI = &get_instance();
        //$this->CI->sdk->getCurlReponse();

    }
   //debug_log("language is kannada");
...
*/
    ...
    {
        //debug_log("language is".$language);
    ...
    public function matchBirthDetails(array $maleBirthData, array $femaleBirthData)
    {
        ...
        $response = $this->getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $_SESSION["language"]);
        return $response;
    }
    ...
    public function timezoneWithDst( $date, $latitude, $longitude)
    {
        ...
        $resData = $this->getCurlReponse($this->userId, $this->apiKey,$resourceName, $data, $_SESSION["language"]);
        return $resData;
    }
    ...
    public function callApi($endPoint, $data){
        $response = $this->getCurlReponse($this->userId, $this->apiKey, $endPoint, $data, $_SESSION["language"]);
        return $response;
    }
