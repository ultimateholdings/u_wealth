...
class Coinpaymentsapi
{
     ...
     * @param short If short == TRUE (the default), the output won't include the currency names and confirms needed to
     *                 save bandwidth.
     */
     ...
     * @param ipn_url Optionally set an IPN handler to receive notices about this transaction. If ipn_url is empty then
     *                               it will use the default IPN URL in your account.
    ...
    public function ConvertCoins($amount, $from, $to, $address = null, $dest_tag = null)
    {
        ...
        return $this->api_call('convert', $fields);
