    ...
    <table class="table table-striped table-bordered">
        ...
        foreach ($meetings as $e) { ?>
            <tr>
                ...
                <?php $user_details = $this->db_model->select_multi('*', 'member', array('id' => $e['user_id'])); ?>
                ...
                <td>
                    <a href="<?php echo site_url('member/edit_meeting/' . $e['id']); ?>" class="btn btn-info btn-sm">Edit</a>
                    <a onclick="return confirm('Are you sure you want to delete this Meeting ?')"
                       href="<?php echo site_url('member/delete_meeting/' . $e['id']); ?>"
    ...
    <div class="modal-dialog" role="document" style="width: 750px;margin: auto;">
        ...
        <div class="modal-body">
            <?php echo validation_errors('<div class="alert alert-danger">','</div>'); ?>
              <form id="create_meeting" action = "<?php echo base_url('member/add_meeting') ?>" method = "POST">
    ...
    $(document).ready(function() {
        ...
        $('#create_meeting').validate({
            ...
            messages: {
                ...
                ads_description: {
                    required: "Please provide a ad description"
                },
                ads_type: {
                    required: "Please provide a ad type"
                }
            },
            errorElement: 'span',
