...
<?php if($data['zoom_meeting']!= NULL) { ?>
    <form action="<?php echo base_url('member/meetingdeatils_update'); ?>" method="POST">
<?php } else { ?>
    <form action="<?php echo base_url('member/meetingdeatils'); ?>" method="POST">
<?php }?>
...
<div class="row">
    <div class="col-sm-6 col-sm-offset-3">
        ...
        <?php 
            ...
            debug_log("zoom_meeting1");
            debug_log($data['zoom_meeting']);
        ?>
        <?php if($data['zoom_meeting']!= NULL) { ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        document.querySelector("#meetings > ul > li:nth-child(3) > a > span").setAttribute('style', 'color: darkorange !important;');
    });
</script>