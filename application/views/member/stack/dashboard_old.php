...
<div class="col-md-12 col-sm-12 mt-4 mb-4" id='earning'>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel item">
                                ...
                                <div class="panel-body">
                                <div class="card-header card-header-primary" style="height: 65px;line-height: 27px;margin-left:-20px;width:105%;margin-top: -61px;">
                                    <h4 class="card-title" style="color:white;font-size:20px;font-weight: 900;">Latest Earnings</h4>
...
<?php if(count($plans)>0) { ?>
    <div class="row">
 <div class="col-md-12 col-sm-12 mt-4 mb-4" id='single'>
    <div class="card">
                                <div class="card-content">
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel item">
                                ...
                                <div class="panel-body">
                                <div class="card-header card-header-primary" style="height: 65px;line-height: 27px;margin-left:-20px;width:105%;margin-top: -61px;">
                  <h4 class="card-title" style="color:white;font-size:20px;font-weight: 900;"><?php echo $this->db_model->select('income_name', 'level_wise_income');?></h4>
                      ...
                      <tbody>
                        ...
                        foreach ($inc as $e):
                          ...
                          <tr>
                              ...
                              <td><label><a href="<?php echo site_url('member/upgrade_id/'.$e->plan_new_id.'/'.$e->id) ?>"> Upgrade </a></label></td>  
                              <?php } ?>
                              <?php } else { ?>
...
<div class="col-md-12 col-sm-12 mt-4 mb-4" id='earning'>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-header card-header-primary" style="background: green;height: 65px;line-height: 27px;margin-left:-20px;width:105%;margin-top: -55px;">
                                                            <h4 class="card-title" style="color:white;font-size:20px;font-weight: 900;">Reward Achievers</h4>
...
if(config_item('enable_club_income')=='Yes'){ ?>
  <div class="col-md-12 col-sm-12 mb-4 mt-4" id='club_income'>
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                       <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-info" style="height: 65px;line-height: 27px;">
                                    <h4 class="card-title" style="color:white;font-size:20px;font-weight: 900;">Club Income</h4>
                ...
                <div class="container-fluid">
                    <div class="row">
                       <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-info" style="height: 65px;line-height: 27px;">
                                    <h4 class="card-title" style="color:white;font-size:20px;font-weight: 900;">Group Income</h4>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="height: 438px;">
                            <div class="card-header card-header-primary bg-info" style="background: blue;height: 65px;line-height: 27px;margin-left:-2px;width:101%;">
                                <h4 class="card-title" style="color:white;font-size:20px;font-weight: 900;">Contact Support</h4>
...
<div class="col-lg-5 col-md-5 col-sm-12"  id="live_updates">
    <div class="panel-body" style="min-height: 360px;">
       
            
             
                        <div class="card" >
                            <div class="card-header card-header-primary" style="background: blue;height: 65px;line-height: 27px; margin-left: -2px;width: 102%;">
                                <h4 class="card-title" style="color:white;font-size:20px;font-weight: 900;">Live Updates</h4>
