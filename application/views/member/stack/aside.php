   ...
   <div class="main-menu-content">
      ...
      <div id="google_translate_element"></div>
        ...
        <?php } ?>            
               ...
               <br/>
               <li class="nav-item active"><a href="<?php echo base_url('member'); ?>"><i class="fa fa-university"></i><span class="menu-title" data-i18n="Dashboard">Dashboard</span></a>
               </li>
               <li class="nav-item" id='wletter'>
                   <a href="<?php echo site_url('member/welcome-letter') ?>"><i class="fa fa-file"></i><span> Welcome Letter</span></a>
               </li>
               ...
               <?php if (config_item('enable_epin')=="Yes") { ?>
                   <li class="nav-item" id='epins'>
                     <a href="#"><i class="fa fa-briefcase"></i><span>My e-PINs</span></a>
                     <ul class="submenu">
           ...
           <?php if(config_item('enable_crm') == "Yes") { ?>
            ...
            <li id="crmstatus" class="nav-item">
          ...
          <?php } ?>
             ...
             <?php } ?>
               ...
               <li id='reports' class="nav-item">
                   <a href="#"><i class="fa fa-file"></i><span>Reports</span></i></a>
                   <ul class="submenu">
                       <li>
