...
<div class="col-md-5 col-sm-12"  id="live_updates">
    <div class="panel-body" style="min-height: 360px;">
        <div class="content">
            <div class="container-fluid">
                <div class="row">
        ...
        <form action = "<?php echo base_url('main/variable_member') ?>/<?php echo $member->id; ?>" method = "POST">
              ...
              <?php echo form_open() ?>  
                ...
                <div class="form-group" style="margin-bottom: 0px;line-height: 23px;">
                    <label>Name</label>
                    <input type="text" id='name' class="form-control" name="name" pattern=".{3,}" title="Enter Valid Name" placeholder="Name" required>
                    <small><?php echo form_error('name'); ?></small>
                    <br>
                    <label>Phone Number</label>
                    <div class="input-group-prepend" >
                        <input type="text" class="form-control" id ='phone' name="phonenumber"  title="Enter Valid Phone Number"  placeholder='Mobile Number' required>
                      </div>
                     <small><?php echo form_error('phonemumber'); ?></small>
                    <br>
                    <label>Email</label>
                    <input type="email" id="email" name="email" class="form-control" title="Enter Valid Email" placeholder='Email Address' required>
                    <small><?php echo form_error('email'); ?></small>

                    <br>
                <label>Feedback</label>
                 <textarea class="form-control" type="varchar"  name="feedback"  id="feed_back" rows="3"  title="enter feedback" placeholder='Feedback' required></textarea>
