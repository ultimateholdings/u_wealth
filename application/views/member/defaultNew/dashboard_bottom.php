 ...
 <div class="col-md-2 col-sm-3 col-sm-offset-4" style="margin-bottom: 5px;">
        <p align="center">
            <a href="<?php echo site_url('member/topup_wallet') ?>"
               class="btn btn-lg btn-success"><span class="<?php echo config_item('cur') ?>"></span> Deposit <i class="fa fa-bank"></i></a>
        </p>
 </div>
<?php */} ?>
 ...
 <div class="col-md-2 col-sm-3" style="margin-bottom: 5px;">
        <p align="center">
            <a href="<?php echo site_url('wallet/withdraw-payouts') ?>"
               class="btn btn-lg btn-primary"><span class="<?php echo config_item('cur') ?>"></span> Withdraw <i class="fa fa-money"></i></a>
        </p>
 </div>
<?php } ?>
</div>
                       ...
                       <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-icon ">
                                  <div class="card-icon"><i ><?php echo config_item('currency');?></i></div>
                                    <h4 class="card-title" >Latest Earnings</h4>
                                    <p class="card-category" > Here is the latest earnings details</p>
                                </div>
                                <div class="card-body">
                                    <div class="table table-responsive">
                                        <table class="table table-hovered table-">
                                            <thead>
                    ...
                    <div class="col-md-12">
                        <div class="card"  >
                           <div class="card-header card-header-icon ">
                                ...
                                <h4 class="card-title">Reward Achievers</h4>
                                <span><i class="pull-right fa-2x fa-trophy-2x"></i></span>
                                <p class="card-category" > Latest Reward Achievers</p>
                            </div>
                            <div class="card-body">
                                <?php
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12" >
                        <div class="card"  >
                         <div class="card-header card-header-icon ">
                                  <div class="card-icon"><i class="fa fa-question"></i></div>
                            ...
                            <div class="card-body" style="box-shadow: 0 4px 20px 0px rgba(0, 0, 0, 0.14), 0 7px 10px -5px rgba(156, 39, 176, 0.4);
    background:  linear-gradient(to bottom right, #6565ff ,#d5d5ff) !important;">
                              ...
                              <form action="<?php echo site_url('ticket/new-ticket'); ?>" method="post">
                                <div class="form-group">
                                  <label style="font-size: 13px;color: white">Subject in Brief*</label>
...
<div class="col-md-5 col-sm-12" style="padding-left: 0px;" id="live_updates">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12" >
                        <div class="card" >
                             <div class="card-header card-header-icon ">
                                  <div class="card-icon"><i class="fa fa-newspaper-o"></i></div>
                                <h4 class="card-title" style="color:white;">Live Updates 
                                  <span class="pull-right">
                                  <div class="wavy1">
                                <span style="--i:1;color: red">New</span></span> 
                                 </div></h4>
    ...
    background:  linear-gradient(to bottom right, #6565ff ,#d5d5ff) !important;">
                              <marquee scrollamount="5" style="width:97%; min-height:228px; margin-bottom:10px; margin-left:auto; margin-right:auto;" direction="up" onmouseover="this.stop()" onmouseout="this.start()">
                                <p style="font-size:16px; color: white; line-height:23px; ">
