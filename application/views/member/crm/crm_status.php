        ...
        foreach ($members as $e) { ?>
            <tr>
               ...
               <td>
                ...
                <a href="<?php echo site_url('member/edit_crm_status/' . $e['id']); ?>" class="btn btn-info btn-sm" style="margin-right: 10px;" >Edit/View</a>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        document.getElementById("crmstatus").classList.add('active');
