...
<div class="card" style="width: 14rem;">
  <div style="background-color: #00CCFF;height: 120px;">
    <div class="row"> 
    <div class="col-md-4"><img src="nophoto.jpg" height="40" style="margin-top: 20px;margin-left: 20px;"></div> 
    <div class="col-md-8" style="margin-top: 25px;float: left">CAN12345</div>
    </div>
  </div>
  <div class="card-body text-center" style="background-color: #e9ecef; margin-top: -32px;height: 50px;float: left">
     <p style="margin-top: -5px;font-weight: 600;">Your First Name</p>
  </div>
  <table>
    <tr>
        <td>Join Date : <span style="float: right;color: green;"> 2020/11/14 </span></td>
    </tr>
    <tr>
        <td>Total Downline : <span style="float: right;color: green;"> 0 </span></td>
    </tr>
    <tr>
        <td>Rank : <span style="float: right;color: green;"> Gold </span></td>
    </tr>
    <tr>
        <td>Plan : <span style="float: right;color: green;"> Joining Plan </span></td>
    </tr>
  </table>
</div>
