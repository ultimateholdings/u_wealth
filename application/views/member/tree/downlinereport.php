...
$data   = $this->db_model->select_multi('total_a, total_b, total_a_investment, total_b_investment, paid_a, paid_b, rank, mypv, total_a_pv, total_b_pv, A, B, C, D, E', 'member', array('id' => htmlentities($top_id)));
?>
<div class="row">
