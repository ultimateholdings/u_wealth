<div class="container frame" style="height:700px;">
  <p><strong><?php echo $this->db_model->select('name', 'member', array('id' => $this->session->user_id)); ?></strong>, This is where you may change your login password</p> 
    <form name="frm" id="frm" method="post" action="#" onsubmit="return validate(this)">
		<input type="hidden" name="com" value="changepass">
	    <div class="table-responsive"> 
	       	<table class="table table-bordered">
		       	<thead>
					<tr>
						<td colspan="2"><h3 style="text-align:center"><b>Change My Login Password</b></h3></td>
					</tr>
				</thead>
				<tbody>
					<tr>
