...
input:placeholder-shown + label {
  ...
  transform: translate(0, 1.7rem) scale(0.99);
  font-weight: 400;
}
/**
             ...
             <?php echo $this->session->flashdata('site_flash') ?>
                <div class="row register-form" > 
                  <div class="field col-sm-6">
                     <input type="text" id="name" name="name" value="<?php echo set_value('name') ?>" placeholder="name">
                  ...
                  <div class="field col-sm-6">
                    <span id="spn_res" style="color: red; font-weight: bold"></span>
                       <input type="number" onchange="get_user_name('#sponsor', '#spn_res')"  
                         ...
                         echo set_value('sponsor', $uri4) ?>" id="sponsor" name="sponsor" placeholder="1001" 
                  ...
                  <div class="field col-sm-6">
                     <!--<input type="email" class="form-control" value="<?php echo set_value('email') ?>" id="email"
                      ...
                      <input type="email" value="<?php echo set_value('email') ?>" id="email"name="email" placeholder="name@domain.com">
                      <label for="email" class="control-label" >Email* 
                      <?php if(config_item('ecomm_theme')=='gmart'){ ?>
                        <a style="cursor: pointer;color: red" data-toggle="tooltip"title="Please use GMART registered e-mail to connect Affiliate Account to GMART Account">
                        (Recommended Email)
                        </a>
                      <?php } ?>
                      </label>
                  ...
                  <div class="field col-sm-6">
                    ...
                    <input type="number"  value="<?php echo set_value('phone') ?>" id="phone" name="phone" placeholder="9xxxxxxxxx" pattern="[1-9]{1}[0-9]{9}" title="Only ten digit phone number is allowed" required onkeypress="return keyRestrict(event, &#39;1234567890&#39;)">
                    <label for="phone" class="control-label">Phone No* (10 Digit Number)</label>
                  </div>
                  <?php } else { ?>
                  <div class="field col-sm-6">
                    <!--<input type="text" class="form-control" value="<?php echo set_value('phone') ?>" id="phone" name="phone" placeholder="9xxxxxxxxx" pattern="[1-9]{1}[0-9]{9}" title="Only ten digit phone number is allowed" required>-->
                    <input type="number"  value="<?php echo set_value('phone') ?>" id="phone" name="phone" placeholder="9xxxxxxxxx" required onkeypress="return keyRestrict(event, &#39;1234567890&#39;)">
                    <label for="phone" class="control-label">Phone No* (10 Digit Number)</label>
                  </div>  
                  <?php } ?>
                  <?php } ?>
                  ...
                  <div class="field col-sm-6">
                    <input type="number" onchange="get_user_name('#position', '#psn_res')" id="position" value="<?php echo set_value('position') ?>" name="position" id="position" placeholder="Where you want to place the ID" onkeypress="return keyRestrict(event, &#39;1234567890&#39;)">
                  ...
                  <div class="field col-sm-6" id="amt_to_pay">
                    <input type="text" required value="<?php echo set_value('amt_to_pay') ?>" id="amt_to_pay"
                      name="amt_to_pay">
                  ...
                  <div class="field col-sm-6">
                    ...
                    <input type="text"value="<?php echo set_value('city') ?>" id="city" name="city" placeholder="Your city">
                    <label for="city" class="control-label">City</label>
                  </div>
                                
                  <div class="field col-sm-6">
                    <!--<input type="text" class="form-control" value="<?php echo set_value('zipcode') ?>" id="zipcode" name="zipcode" required>-->
                    <input type="number"  value="<?php echo set_value('zipcode') ?>" id="zipcode" name="zipcode" required onkeypress="return keyRestrict(event, &#39;1234567890&#39;)" placeholder="Your Zipcode">
                  ...
                  <div class="field col-sm-6">
                    ...
                    <input type="password"  value="<?php echo set_value('password') ?>" id="password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[^a-zA-Z0-9])(?!.*\s).{8,15}" title="Must contain at least one number and one uppercase and lowercase letter and special character, and at least 8 or more  and less than 15 characters"placeholder="password" required>
                    <label for="password" class="control-label">Password*</label>
                  </div>
                                
                  <div class="field col-sm-6">
                    <input type="password" value="<?php echo set_value('password_2') ?>"
                                           id="password_2" placeholder="Retype password" name="password_2">
