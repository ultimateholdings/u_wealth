                    ...
                    <div class="row">
                      <div class="col-md-6 mb-2">
                        <div class="form-outline">
                          <label for="name" class="control-label">Name* <?php if(config_item('company_country')=='India') { echo '';} ?></label>
  ...
  <div class="row">
   ...
   <div class="col-md-6 mb-2">
    <div class="form-outline">
      ...
      <input type="number" class="form-control" value="<?php echo set_value('zipcode') ?>" id="zipcode" name="zipcode" required onkeypress="return keyRestrict(event, &#39;1234567890&#39;)">                          </div>
    </div>
  </div>
  <div class="row">
    <div class="col-md-6 mb-2">
