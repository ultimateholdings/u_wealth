...
<div class="container-fluid register">
    <div class="row">
           <div class="col-md-3 register-left"><span><?php if((config_item('is_demo') == TRUE) || ($this->db_model->select('description', 'settings', array('type' => 'flag')) == 1))  {
             ...
             <a name="" class="btn btn-primary"href="<?php echo site_url('site/login') ?>" value="Login">Login Here</a><br/>
          </div>
