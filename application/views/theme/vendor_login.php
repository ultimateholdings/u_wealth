...
<body>
    ...
    <div id="divElement">
        <?php echo form_open() ?>
        <h2 align="center" style="text-transform: none;">Vendor Access</h2><p>&nbsp;</p>
        <div class="container" align="center">
            <div class="row" style="max-width: 400px; text-align: left">
                <div class="form-group col-sm-12">
                    ...
                    <label for="user" class="control-label">Vendor ID</label>
                ...
                <div class="form-group col-sm-12">
                    ...
                    <a href="<?php echo site_url('site/vendor_register') ?>">Register</a><br/>
            </center>
                </div>
            </div>
        </div>
