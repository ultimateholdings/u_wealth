...
<div class="loader">
  ...
  <h2><b style="color: blue;">Payment Details Screen!!!!</b></h2>
          <br/>
          ...
          <div class="text"> 
                    ...
                    <select class="form-control" id="exampleFormControlSelect1" >
                      ...
                      <?php foreach($result as $element){ ?>
                        <option value="<?php echo $element['id'] ?>"><?php echo $element['categoryCode']."  "; echo $element['time'];  ?> </option>         
                      <?php } ?> 
                    </select> 
                    <br />                     
                      <button type="button" id="fetch" class="btn btn-primary" >Get Bill Details</button>
                    </form>
...
$('#fetch').on('click', function() {  
  ...
  $.ajax({
            url: ' <?php echo base_url()?>bbps_recharge/getReceiptDetails/'+billId,
