...
<div class="loader">
  ...
  <div style="float:left"> 
          <h2><b style="color: blue;">Compliant Status Screen!!!!</b></h2>
          <br/>
          <label>Please Select Reference Number</label>
          </div>
        ...
        <div class="contentBx active" id="content1" style="border: none;right:15%;width:55%"> 
          ...
          <div class="text"> 
                    ...
                    <select class="form-control" id="exampleFormControlSelect1" required>
                      <option value="">Select Refernce Number</option>
                      <?php foreach($result as $element){ ?>
                        <option value="<?php echo $element['reference_id'] ?>"><?php echo $element['reference_id'];  ?> </option>         
                      <?php } ?> 
                    </select> 
                    <br />                    
                      <button type="button" id="fetch" class="btn btn-primary" >Get Compliant Status</button>
                    </form>
...
$('#fetch').on('click', function() {    
  ...
  $.ajax({
            url: ' <?php echo base_url()?>bbps_recharge/getCompliantStatus/'+billId,
  ...
  }else
  {
    if(billId==""  )
  {
    errorMessage="Please select compliant bill!!";
  }
