...
<div id="ui" class="ui">
  ...
  <ul class="nav" ui-nav>
      ...
      <li id="billpayment" class="active">
      ...
      <li id='compliantrequest'>
          <a href="<?php echo site_url('bbps_recharge/customerReceipt') ?>"><i
...
<div class="loader">
  ...
  <a href="<?php echo site_url('bbps_recharge') ?>" style="color:blue; text-decoration: underline;">Go back to Bill Payment Screen</a>
  <h2><?php echo $resultMessage ?></h2>
  <h3 style="color:blue;">Payment Details Below!!!</h3>
          </div>
        ...
        <div class="contentBx active" id="content1" style="border: none;right:15%;width:35%"> 
          <div class="shadow-lg p-3 mb-5 bg-gray rounded mt-4" style="border: none;">
                ...
                <div class="text" style="border: none;"> 
                    ...
                    <tr>
                    <td style='padding: 10px 10px 10px 10px;'>Category Name
                    </td>
                    <td style='padding: 10px 10px 10px 10px;'><?php echo $catCode; ?>
                    </td>
                    </tr>
                    <tr>
                    <td style='padding: 10px 10px 10px 10px;' >Biller Name
                    </td>
                    <td style='padding: 10px 10px 10px 10px;'><?php echo $billerName; ?>
                    </td>
                    </tr>
                    <tr>
                    <td style='padding: 10px 10px 10px 10px;' >Amount
                    </td>
                    <td style='padding: 10px 10px 10px 10px;' ><?php echo $amount; ?>
                    </td>
                    </tr>
                    <tr>
                    <td style='padding: 10px 10px 10px 10px;'>BBPS Transaction ID
                    </td>
                    <td style='padding: 10px 10px 10px 10px;'><?php echo $bbps_transaction_id; ?>
                    </td>
                    </tr>
                    <tr>
                    <td style='padding: 10px 10px 10px 10px;'>SourceRefNum
                    </td>
                    <td style='padding: 10px 10px 10px 10px;'><?php echo $sourceRefNum; ?>
                    </td>
                    </tr>
                    
                    <tr>
                    <td style='padding: 10px 10px 10px 10px;'>Status Code
                    </td>
                    <td style='padding: 10px 10px 10px 10px;'><?php echo $statusCode; ?>
                    </td>
                    </tr>
                    <tr>
                    <td style='padding: 10px 10px 10px 10px;'>Status Message
                    </td>
                    <td style='padding: 10px 10px 10px 10px;'><?php echo $statusMessage; ?>
                    </td>
                    </tr>
                    <tr>
                    <td style='padding: 10px 10px 10px 10px;'>Trace ID
                    </td>
                    <td style='padding: 10px 10px 10px 10px;'><?php echo $trace_id; ?>
                    </td>
                    </tr>
                    </table>
                </div>
