...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active"><a href="<?php echo site_url('site/App/welfare/index') ?>" class="nav-link">Home</a></li>
          <li class="nav-item"><a href="<?php echo site_url('site/App/welfare/about')?>" class="nav-link">About</a></li>
    				...
    				<div class="carousel-cause owl-carousel">
	    				<div class="item">
	    					<div class="cause-entry">
		    					<a href="#" class="img" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/cause-1.jpg);"></a>
	    				...
	    				<div class="item">
	    					<div class="cause-entry">
		    					<a href="#" class="img" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/cause-2.jpg);"></a>
		    					<div class="text p-3 p-md-4">
		    						<h3><a href="#">Clean water for the urban area</a></h3>
		    						<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life</p>
		    						<span class="donation-time mb-3 d-block">Last donation 1w ago</span>
	    				...
	    				<div class="item">
	    					<div class="cause-entry">
		    					<a href="#" class="img" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/cause-3.jpg)"></a>
		    					<div class="text p-3 p-md-4">
		    						<h3><a href="#">Clean water for the urban area</a></h3>
		    						<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life</p>
		    						<span class="donation-time mb-3 d-block">Last donation 1w ago</span>
	    				...
	    				<div class="item">
	    					<div class="cause-entry">
		    					<a href="#" class="img" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/cause-4.jpg)"></a>
		    					<div class="text p-3 p-md-4">
		    						<h3><a href="#">Clean water for the urban area</a></h3>
		    						<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life</p>
		    						<span class="donation-time mb-3 d-block">Last donation 1w ago</span>
	    				...
	    				<div class="item">
	    					<div class="cause-entry">
		    					<a href="#" class="img" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/cause-5.jpg)"></a>
		    					<div class="text p-3 p-md-4">
		    						<h3><a href="#">Clean water for the urban area</a></h3>
		    						<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life</p>
		    						<span class="donation-time mb-3 d-block">Last donation 1w ago</span>
	    				...
	    				<div class="item">
	    					<div class="cause-entry">
		    					<a href="#" class="img" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/cause-6.jpg)"></a>
		    					<div class="text p-3 p-md-4">
		    						<h3><a href="#">Clean water for the urban area</a></h3>
		    						<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life</p>
		    						<span class="donation-time mb-3 d-block">Last donation 1w ago</span>
    ...
    <section class="ftco-gallery">
    	<div class="d-md-flex">
	    	<a href="<?php echo base_url();?>axxets/templates/welfare/images/cause-2.jpg" class="gallery image-popup d-flex justify-content-center align-items-center img ftco-animate" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/cause-2.jpg)">
	    		<div class="icon d-flex justify-content-center align-items-center">
	    			<span class="icon-search"></span>
	    		</div>
	    	</a>
	    	<a href="<?php echo base_url();?>axxets/templates/welfare/images/cause-3.jpg" class="gallery image-popup d-flex justify-content-center align-items-center img ftco-animate" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/cause-3.jpg)">
	    		<div class="icon d-flex justify-content-center align-items-center">
	    			<span class="icon-search"></span>
	    		</div>
	    	</a>
	    	<a href="<?php echo base_url();?>axxets/templates/welfare/images/cause-4.jpg" class="gallery image-popup d-flex justify-content-center align-items-center img ftco-animate" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/cause-4.jpg);">
	    		<div class="icon d-flex justify-content-center align-items-center">
	    			<span class="icon-search"></span>
	    		</div>
	    	</a>
	    	<a href="<?php echo base_url();?>axxets/templates/welfare/images/cause-5.jpg" class="gallery image-popup d-flex justify-content-center align-items-center img ftco-animate" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/cause-5.jpg);">
	    		<div class="icon d-flex justify-content-center align-items-center">
	    			<span class="icon-search"></span>
	    		</div>
	    	</a>
    	...
    	<div class="d-md-flex">
	    	<a href="<?php echo base_url();?>axxets/templates/welfare/images/cause-6.jpg" class="gallery image-popup d-flex justify-content-center align-items-center img ftco-animate" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/cause-6.jpg);">
	    		<div class="icon d-flex justify-content-center align-items-center">
	    			<span class="icon-search"></span>
	    		</div>
	    	</a>
	    	<a href="<?php echo base_url();?>axxets/templates/welfare/images/image_3.jpg" class="gallery image-popup d-flex justify-content-center align-items-center img ftco-animate" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/image_3.jpg);">
	    		<div class="icon d-flex justify-content-center align-items-center">
	    			<span class="icon-search"></span>
	    		</div>
	    	</a>
	    	<a href="<?php echo base_url();?>axxets/templates/welfare/images/image_1.jpg" class="gallery image-popup d-flex justify-content-center align-items-center img ftco-animate" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/image_1.jpg);">
	    		<div class="icon d-flex justify-content-center align-items-center">
	    			<span class="icon-search"></span>
	    		</div>
	    	</a>
	    	<a href="<?php echo base_url();?>axxets/templates/welfare/images/image_2.jpg" class="gallery image-popup d-flex justify-content-center align-items-center img ftco-animate" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/image_1.jpg);">
	    		<div class="icon d-flex justify-content-center align-items-center">
	    			<span class="icon-search"></span>
	    		</div>
	    	</a>
      ...
      <div class="container">
        ...
        <div class="row d-flex">
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="<?php echo site_url('site/blog-single')?>" class="block-20" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/image_1.jpg);">
              </a>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry align-self-stretch">
              <a href="<?php echo site_url('site/blog-single')?>" class="block-20" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/image_2.jpg);">
              </a>
              <div class="text p-4 d-block">
              	<div class="meta mb-3">
                  <div><a href="#">Sept 10, 2018</a></div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry align-self-stretch">
              <a href="<?php echo site_url('site/blog-single')?>" class="block-20" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/image_3.jpg);">
              </a>
              <div class="text p-4 d-block">
              	<div class="meta mb-3">
                  <div><a href="#">Sept 10, 2018</a></div>
    ...
    <section class="ftco-section bg-light">
      <div class="container">
        ...
        <div class="row">
        	<div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry align-self-stretch">
              <a href="<?php echo site_url('site/blog-single')?>" class="block-20" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/event-1.jpg);">
              </a>
              <div class="text p-4 d-block">
              	<div class="meta mb-3">
                ...
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
                <p><a href="<?php echo site_url('site/event')?>">Join Event <i class="ion-ios-arrow-forward"></i></a></p>
              </div>
            </div>
          </div>
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry align-self-stretch">
              <a href="<?php echo site_url('site/blog-single')?>" class="block-20" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/event-2.jpg);">
              </a>
              <div class="text p-4 d-block">
              	<div class="meta mb-3">
                  <div><a href="#">Sep. 10, 2018</a></div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry align-self-stretch">
              <a href="<?php echo site_url('site/blog-single')?>" class="block-20" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/event-3.jpg);">
              </a>
              <div class="text p-4 d-block">
              	<div class="meta mb-3">
                  <div><a href="#">Sep. 10, 2018</a></div>
		...
		<section class="ftco-section-3 img" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/bg_3.jpg);">
    	<div class="overlay"></div>
    	<div class="container">
    		<div class="row d-md-flex">
    		<div class="col-md-6 d-flex ftco-animate">
    			<div class="img img-2 align-self-stretch" style="background-image: url(<?php echo base_url();?>axxets/templates/welfare/images/bg_4.jpg);"></div>
    		</div>
