...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="<?php echo site_url('site/about')?>" class="nav-link">About</a></li>
    ...
    <div class="hero-wrap" style="background-image: url(<?php echo base_url();?>axxets/welfare/images/bg_6.jpg);" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
             <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="<?php echo base_url('/') ?>">Home</a></span> <span>Donate</span></p>
      ...
      <div class="container">
        <div class="row">
        	<div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
        			<div class="d-flex mb-4">
        				<div class="img" style="background-image: url(<?php echo base_url();?>axxets/welfare/images/person_1.jpg);"></div>
        				<div class="info ml-4">
        	...
        	<div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
        			<div class="d-flex mb-4">
        				<div class="img" style="background-image: url(<?php echo base_url();?>axxets/welfare/images/person_2.jpg);"></div>
        				<div class="info ml-4">
        	...
        	<div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
        			<div class="d-flex mb-4">
        				<div class="img" style="background-image: url(<?php echo base_url();?>axxets/welfare/images/person_3.jpg);"></div>
        				<div class="info ml-4">
        					<h3><a href="#">Ivan Jacobson</a></h3>
        					<span class="position">Donated Just now</span>
        					<div class="text">
        	...
        	<div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
        			<div class="d-flex mb-4">
        				<div class="img" style="background-image: url(<?php echo base_url();?>axxets/welfare/images/person_4.jpg);"></div>
        				<div class="info ml-4">
        					<h3><a href="#">Ivan Jacobson</a></h3>
        					<span class="position">Donated Just now</span>
        					<div class="text">
        	...
        	<div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
        			<div class="d-flex mb-4">
        				<div class="img" style="background-image: url(<?php echo base_url();?>axxets/welfare/images/person_5.jpg);"></div>
        				<div class="info ml-4">
        					<h3><a href="#">Ivan Jacobson</a></h3>
        					<span class="position">Donated Just now</span>
        					<div class="text">
        	...
        	<div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
        			<div class="d-flex mb-4">
        				<div class="img" style="background-image: url(<?php echo base_url();?>axxets/welfare/images/person_6.jpg);"></div>
        				<div class="info ml-4">
        					<h3><a href="teacher-single.html">Ivan Jacobson</a></h3>
        					<span class="position">Donated Just now</span>
        					<div class="text">
        	...
        	<div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
        			<div class="d-flex mb-4">
        				<div class="img" style="background-image: url(<?php echo base_url();?>axxets/welfare/images/person_7.jpg);"></div>
        				<div class="info ml-4">
        					<h3><a href="#">Ivan Jacobson</a></h3>
        					<span class="position">Donated Just now</span>
        					<div class="text">
        	...
        	<div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
        			<div class="d-flex mb-4">
        				<div class="img" style="background-image: url(<?php echo base_url();?>axxets/welfare/images/person_8.jpg);"></div>
        				<div class="info ml-4">
        					<h3><a href="#">Ivan Jacobson</a></h3>
        					<span class="position">Donated Just now</span>
        					<div class="text">
        	...
        	<div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
        			<div class="d-flex mb-4">
        				<div class="img" style="background-image: url(<?php echo base_url();?>axxets/welfare/images/person_9.jpg);"></div>
        				<div class="info ml-4">
        					<h3><a href="#">Ivan Jacobson</a></h3>
        					<span class="position">Donated Just now</span>
        					<div class="text">
    ...
    <section class="ftco-section-3 img" style="background-image: url(<?php echo base_url();?>axxets/welfare/images/bg_3.jpg);">
    	<div class="overlay"></div>
    	<div class="container">
    		<div class="row d-md-flex">
    		<div class="col-md-6 d-flex ftco-animate">
    			<div class="img img-2 align-self-stretch" style="background-image: url(<?php echo base_url();?>axxets/welfare/images/bg_4.jpg);"></div>
    		</div>
