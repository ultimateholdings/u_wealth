...
<ol class="breadcrumb ">
  ...
  <li class="breadcrumb-item active">Ascendant</li>
</ol>
<section>
	<div class="container mt-5">
		<div class="text-center mt-5 mb-5">
		   <h1>Get to know your Ascendant as per your Kundli</h1>
		</div>
		<div class="card shadow-lg p-3 mb-5 bg-white rounded" style="margin: 0 20%;">
			<div class="card-body">
				<div class="mt-5 mb-5" style="padding:0 15%;">	
					...
					<?php echo form_open('Astrology/general_reports',['autocomplete'=>'off']); ?>
					<div class="row">
						<?php $this->load->view('astrology/inc/FormInput') ?>
					    <div id="form_button">
					  	<?php echo form_submit($data = array('type' => 'submit','value'=> 'Get your Gemstone Analysis','class'=> 'submit btn btn-primary btn-lg btn-block mt-3 ml-3')); ?>
					  	</div>
					<!--</form>-->
					</div>
					<?php echo form_close(); ?>
