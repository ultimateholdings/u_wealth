...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">Kalsarpa Dosha</li>
</ol>

<section>
	<div class="container mt-5">
		<div class="text-center mt-5 mb-5">
		   <h1>Is the serpentine energy of Rahu and Ketu hindering your progress? Get Your Kalsarpa Dosha Analysis Now</h1>
		</div>
		<div class="card shadow-lg p-3 mb-5 bg-white rounded" style="margin: 0 20%;">
			<div class="card-body">
				<div class="mt-5 mb-5" style="padding:0 15%;">	
					...
					<?php echo form_open('Astrology/kalsarpa_dasha',['autocomplete'=>'off']); ?>

					<div class="row">
					   <?php $this->load->view('astrology/inc/FormInput') ?>
					    <div id="form_button">
					  	<?php echo form_submit($data = array('type' => 'submit','value'=> 'Get your Kalsarpa-dosha Analysis','class'=> 'submit btn btn-primary btn-lg btn-block mt-3 ml-3')); ?>
					  </div>
					<!--</form>-->
					<?php echo form_close(); ?>
				</div>	
