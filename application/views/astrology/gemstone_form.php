...
<section>
	<div class="container mt-5">
		<div class="text-center mt-5 mb-5">
		   <h1>Get Your Kundli Based Gemstone Recommendation for Better Luck and Success</h1>
		</div>
		<div class="card shadow-lg p-3 mb-5 bg-white rounded" style="margin: 0 20%;">
			<div class="card-body">
				<div class="mt-5 mb-5" style="padding:0 15%;">	
					...
					<?php echo form_open('Astrology/suggestions_remedies_gemstone',['autocomplete'=>'off']); ?>
					<div class="row">
