...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">Pitra-dosh</li>
</ol>

<section>
	<div class="container mt-5">
		<div class="text-center mt-5 mb-5">
		   <h1>Do You Have Karmic Debt of Your Ancestors? Get Your Pitra Dosha Analysis for Free</h1>
		</div>
		<div class="card shadow-lg p-3 mb-5 bg-white rounded" style="margin: 0 20%;">
			<div class="card-body">
				<div class="mt-5 mb-5" style="padding:0 15%;">	
					...
					<?php echo form_open('Astrology/pitri_dasha',['autocomplete'=>'off']); ?>

					<div class="row">
					    <?php $this->load->view('astrology/inc/FormInput') ?>
					    <div id="form_button">
					  	<?php echo form_submit($data = array('type' => 'submit','value'=> 'Get your Pitri-dosha Analysis','class'=> 'submit btn btn-primary btn-lg btn-block mt-3 ml-3')); ?>
					  </div>
					<!--</form>-->
					<?php echo form_close(); ?>
				</div>	
