...
?>
<?php echo form_open() ?>
<div class="alert alert-warning" style="display: none;">Instamojo Setting (Need Instamojo Account ? Contact Us)</div>
<div class="row" style="display: none;">
    <div class="col-sm-12">
        <input type="checkbox" value="Yes"
               name="enable_instamojo" <?php if (config_item('enable_instamojo') == "Yes") echo 'checked'; ?> disabled> 
               Enable Instamojo ?
        <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
                ...
                <input type="password" value="<?php echo set_value('instamojo_auth', config_item('instamojo_auth')) ?>"
                       placeholder="Private Auth Token" class="form-control" name="instamojo_auth">
            </div>
            <div class="col-sm-6">
                <label>Private Salt</label>
                <input type="password" value="<?php echo set_value('instamojo_salt', config_item('instamojo_salt')) ?>"
                       placeholder="Private Salt" class="form-control" name="instamojo_salt">
            </div>
        </div>
    </div>
</div><p>&nbsp;</p>
<h4> Please Contact Support for enabling below Payment Gateways</h4>
<br>
...
<div class="alert alert-info">Cash Free Setting</div>
<div class="alert alert-info" style="display: none;">Razor Pay Setting</div>
<div class="alert alert-info" style="display: none;">PayuMoney Setting</div>
<div class="row" style="display: none;">
    <div class="col-sm-12">
        <input type="checkbox" value="Yes"
...
<div class="alert alert-info" style="display: none;">Block.io (BITCOIN, DOGECOIN, OR LITECOIN)</div>
<div class="row" style="display: none;">
    <div class="col-sm-12">
        <input type="checkbox" value="Yes"
...
<div class="col-sm-6" style="display: none;"><br/>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        document.querySelector('.payment').setAttribute('style', 'color: darkorange !important;');
    });
</script>