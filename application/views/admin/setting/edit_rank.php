    ...
    <div class="form-group">
        ...
        <div class="row">
            <div class="col-sm-5">
                    ...
                    <select class="form-control" id="rank_type" name="rank_type" disabled>
        ...
        <input type="hidden" name="rank_type" value="<?php echo $result->type ?>">
        <div class="row" id='downline_id'>
            ...
            <?php if(config_item('width')=='2') { ?>
                ...
                <div class="col-sm-5">
                    ...
                    <input required type="text" class="form-control" placeholder="How many people or PV at <?php echo $key ?> side ?" name="<?php echo $key ?>" value="<?php echo set_value($key, $result->$key) ?>">
                </div>
                <?php } ?>
            <?php } else { ?>
                <div class="col-sm-5">
            ...
            <div class="col-sm-5">
                ...
                <input type="text" class="form-control" value="<?php echo set_value('downline_rank', $result->downline_rank) ?>"
                       name="downline_rank">
            </div>
        </div>
        <div>&nbsp;</div>
        ...
        <div class="row">
            <div class="col-sm-12"><br/>
                ...
                <a href="<?php echo site_url('setting/rank-setting');?>" id="cancel" name="cancel" class="btn btn-default">Cancel</a>
            </div>
        </div>
    </div>
    <?php echo form_close() ?>
