...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item active">
    <a class="nav-link active <?php echo $style['element']; ?>" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><?php echo "Images"; ?></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false"><?php echo "Company Details"; ?></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="social-tab" data-toggle="tab" href="#social" role="tab" aria-controls="social" aria-selected="false"><?php echo "Social Media"; ?></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="bank-tab" data-toggle="tab" href="#bank" role="tab" aria-controls="bank" aria-selected="false"><?php echo "Bank Details"; ?></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="upi-tab" data-toggle="tab" href="#upi" role="tab" aria-controls="upi" aria-selected="false"><?php echo "UPI Details"; ?></a>
  </li>
  <li class="nav-item">
...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade active <?php echo $style['element']; ?>" id="home" role="tabpanel" aria-labelledby="home-tab" >
        <div class="row">
            <div class="col-sm-offset-1 col-sm-10">
                <label style="font-style: bold; font-size: 16px; color: blue;">All Logos must be Transparent with PNG Format</label>
                <br><br>
            </div>
            <div class="col-sm-offset-1 col-sm-5">
                <label>Home Page Logo <?php if(config_item('homepage')=='home/index') { echo '(200*40)'; } else if(config_item('homepage')=='store/store') { echo '(171*60)'; } else {echo '(200*40)';}?></label>
                <br>
                <span class="btn btn-default btn-file" style="margin-top: 10px;"><input name="logo" type="file"/></span>
            </div>
            <div class="col-sm-5">
                Logo with Light Text (160*50)
                <br/>
                <span class="btn btn-default btn-file" style="margin-top: 10px;"><span></span><input name="logo_light" type="file"/></span>
            </div>
        </div>
        <div>&nbsp;</div>
        <div>&nbsp;</div>
