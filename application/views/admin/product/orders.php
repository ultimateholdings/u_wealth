<?php
//print_r($this->session->name);die();
$name=$this->db_model->select('username', 'staffs', array('username' =>$this->session->name ));
?>
<div class="table-responsive">
    <table class="table table-striped table-bordered" id="DTable" data-page-length='100' data-name="Pending_order_list" data-export='Yes'>
      <thead>
        <tr>
            <th>SN</th>
            <th>User ID</th>
                    ...
                    { 
                        ...
                        { ?>
                         <a style="display:none;" data-toggle="modal" data-target="#shipped_modal"
                           ...
                           class="btn btn-primary btn-sm mb-1"  style="color: white;" >Update Tracking</a> <br>
                         
                           
                         <a data-toggle="modal" data-target="#myModal"
                           onclick="document.getElementById('deliverid').value='<?php echo $e->id ?>'"
                           class="btn btn-primary btn-sm mb-1" style="color: white;">Mark Completed</a> <br>
                          <?php } else { ?>
                         ...
                         <a  data-toggle="modal"  data-target="#delivered_modal"
                           ...
                           class="btn btn-primary btn-sm mb-1" style="color: white;" >Mark Delivered</a>
                         <a data-toggle="modal" data-target="#myModal"
                           onclick="document.getElementById('deliverid').value='<?php echo $e->id ?>'"
                           class="btn btn-primary btn-sm mb-1" style="color: white;" >Mark Completed</a> 
                           <?php 
                            }} ?>   
                         <a href="<?php echo site_url('product/view_order/' . $e->id); ?>"
                          class="btn btn-success btn-sm mb-1">View</a>
                          <a href="<?php echo site_url('product/print_order/' . $e->id); ?>"
                            class="btn btn-info btn-sm mb-1">Print Label</a>
                       ...
                       href="<?php echo site_url('product/remove_order/' . $e->id); ?>" class="btn btn-danger btn-sm">Delete</a>
                      <?php } ?>
               </td>
                ...
                if($e->vendor_id!='1')
                {
                 ...
                 <td>
                    <?php if ($e->status !== "Completed") { 
                        ...
                        { ?>
                         <a style="display:none;" data-toggle="modal" data-target="#shipped_modal"
                           onclick="document.getElementById('shippedid').value='<?php echo $e->id ?>'"
                           class="btn btn-primary btn-sm mb-1" >Update Tracking</a> <br>
                         <a style="display:none;" data-toggle="modal" data-target=""
                           onclick="document.getElementById('mark_deliverid').value='<?php echo $e->id ?>'"
                           class="btn btn-primary btn-sm mb-1" disabled >MarK Delivered</a>
                           <?php if($name!=""){ ?>
                         <a data-toggle="modal" data-target="#myModal"
                           onclick="document.getElementById('deliverid').value='<?php echo $e->id ?>'"
                           class="btn btn-primary btn-sm mb-1">Mark Completed</a> <br>
                          <?php } } else { ?>
                         <a style="display:none;" data-toggle="modal" data-target="#shipped_modal"
                           onclick="document.getElementById('shippedid').value='<?php echo $e->id ?>'"
                           class="btn btn-primary btn-sm mb-1" >Update Tracking</a> <br>
                         <a style="display:none;" data-toggle="modal"  data-target="#delivered_modal"
                           onclick="document.getElementById('mark_deliverid').value='<?php echo $e->id ?>'"
                           class="btn btn-primary btn-sm mb-1" >Mark Delivered</a>
                           <?php 
                           if($name!="")
                           { ?>
                             <a  data-toggle="modal" data-target="#myModal"
                            onclick="document.getElementById('deliverid').value='<?php echo $e->id ?>'"
                            class="btn btn-primary btn-sm mb-1">Mark Completed</a> 
                             <br>
                            <?php 
                           } }} ?>   
                         <a href="<?php echo site_url('product/view_order/' . $e->id); ?>"
                 ...
                 <td>
                    ...
                    { 
                     ...
                     <a target="_blank" href="<?php echo site_url('accounting/invoice_view/' . $this->db_model->select('id', 'invoice', array('order_id'=>$e->id))); ?>" class="btn btn-warning btn-sm mb-1">Print Invoice</a>
                      <?php if($e->product_id > 0) { ?>
                     <a style="display:none;" onclick="return confirm('Are you sure you want to delete this Order ?')"
                       href="<?php echo site_url('product/remove_order/' . $e->id); ?>" class="btn btn-danger btn-sm mb-1">Delete</a>
                      <?php } ?>
                 </td>
                   <?php 
                  } 
