...
<div >
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6" style="display: flex;align-items: center;" id="image">
            <label>Image</label>
    ...
    <table class="table table-striped table-bordered">
        ...
        if($brand) {
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo site_url('admin/edit_brand/' . $e['brand_id']); ?>" class="btn btn-info btn-xs">Edit</a>
