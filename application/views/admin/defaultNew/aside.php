<div class="sidebar-container">
   <div id='sidebarmenu' class="sidemenu-container navbar-collapse collapse fixed-menu"  style="overflow-y: scroll!important;">
      <div id="remove-scroll">
         <ul class="sidemenu  page-header-fixed"
            data-keep-expanded="false"data-scroll-to-active="true"
         ...
         <li class=" nav-item"><a href="<?php echo site_url('email'); ?>"><i class="fa fa-file-text-o"></i><span class="title" data-i18n="Templates">Email</span></a>
                </li>
         <?php } ?>
            ...
            <li id = 'earningpay' class="nav-item">
               ...
               <ul class="sub-menu">
                  ...
                  <li class="nav-item">
                     <a href="<?php echo site_url('income/voucher_transactions') ?>"
                        class="nav-link ">
                     <span class="title">Voucher Transactions</span>
                     </a>
                  </li>
               </ul>
            </li>
            ...
            <?php if (!isset($this->session->designation) || $this->session->designation['bank_compliance'] == "1") { ?>
            <li id='kyc' class="nav-item">
               <a href="#" class="nav-link nav-toggle">
               <i class="fa fa-users"></i>
               <span class="title">Bank Compliance</span>
               <span class="arrow"></span>
               </a>
               <ul class="sub-menu">
                  <li class="nav-item">
                     <a href="<?php echo site_url('users/pending_bankdetails') ?>"class="nav-link ">
                     <span class="title">Pending Bank Details</span>
                     </a>
                  </li>
                  <li class="nav-item">
                     <a href="<?php echo site_url('users/approved_bankdetails') ?>"
                        class="nav-link ">
                     <span class="title">Approved Bank Details</span>
                     </a>
                  </li>
                  <li class="nav-item">
                     <a href="<?php echo site_url('users/rejected_bankdetails') ?>"
                        class="nav-link ">
                     <span class="title">Rejected Bank Details</span>
                     </a>
                  </li>
               </ul>
            </li>
            ...
            <li id = 'rewards' class="nav-item">
               ...
               <span class="title">Rewards<div class="wavy">
               ...
               <ul class="sub-menu">
                  ...
                  <li class="nav-item">
                     <a href="<?php echo site_url('setting/voucher-setting') ?>"
                        class="nav-link ">
                     <span class="title">Voucher Reward Setting</span>
                     </a>
                  </li>
                  <li class="nav-item">
                     <a href="<?php echo site_url('setting/voucher_achievers') ?>"
                        class="nav-link ">
                     <span class="title">Voucher Reward Achievers</span>
                     </a>
                  </li>
               </ul>
            </li>
