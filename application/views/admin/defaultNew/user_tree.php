...
<div class="row">
    <div class="col-sm-4">
        <table class="table" style="border-top: 1.3px solid white;">
            <tr>
                <td style="font-size: 12px" width="33.33%">
                    <img src="<?php echo base_url('uploads/site_img/green.png') ?>" class="img-circle img-fluid"><br/>
                    Green User
                </td>
                <td style="font-size: 12px" width="33.33%">
                    <img src="<?php echo base_url('uploads/site_img/new.png') ?>" class="img-circle img-fluid"><br/>
                    No User
                </td>
            </tr>
        </table>
    ...
    <div class="col-sm-8">
        <form method="post" action="<?php echo site_url('tree/user_tree_upgrade') ?>">
            <div class="row">
            <div class="col-sm-4" >
...
<?php if(($width==2)&&(config_item('width')==2)) { ?>
    <div class="col-sm-12">
            <div class="table-responsive">
                <table class="table table-borderless">
                    <tbody>
                    <tr>
                        <td colspan="8" align="center"><?php $U = $this->plan_model->create_binary_tree($top_id,'','',$plan_id);
                    ...
                    <tr>
                        <td colspan="4"
                            align="center"><?php $A = $this->plan_model->create_binary_tree($U['A'], $U['id'], 'A',$plan_id);
                            echo $A['data'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>"
                                                        class="img-responsive">
                        </td>
                        <td colspan="4"
                            align="center"><?php $B = $this->plan_model->create_binary_tree($U['B'], $U['id'], 'B',$plan_id);
                    ...
                    <tr>
                        <td colspan="2"
                            align="center"><?php $A_1 = $this->plan_model->create_binary_tree($A['A'], $A['id'], 'A',$plan_id);
                            echo $A_1['data'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>"
                                                          class="img-responsive">
                        </td>
                        <td colspan="2"
                            align="center"><?php $A_2 = $this->plan_model->create_binary_tree($A['B'], $A['id'], 'B',$plan_id);
                            echo $A_2['data'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>"
                                                          class="img-responsive">
                        </td>
                        <td colspan="2"
                            align="center"><?php $B_1 = $this->plan_model->create_binary_tree($B['A'], $B['id'], 'A',$plan_id);
                            echo $B_1['data'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>"
                                                          class="img-responsive">
                        </td>
                        <td colspan="2"
                            align="center"><?php $B_2 = $this->plan_model->create_binary_tree($B['B'], $B['id'], 'B',$plan_id);
                            echo $B_2['data'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>"
                                                          class="img-responsive">
                        </td>
                    </tr>
                    <tr>
                        <td align="left"><?php $A1_1 = $this->plan_model->create_binary_tree($A_1['A'], $A_1['id'], 'A',$plan_id);
                            echo $A1_1['data'] ?></td>
                        <td align="right"><?php $A1_2 = $this->plan_model->create_binary_tree($A_1['B'], $A_1['id'], 'B',$plan_id);
                            echo $A1_2['data'] ?></td>
                        <td align="left"><?php $A2_1 = $this->plan_model->create_binary_tree($A_2['A'], $A_2['id'], 'A',$plan_id);
                            echo $A2_1['data'] ?></td>
                        <td align="right"><?php $A2_2 = $this->plan_model->create_binary_tree($A_2['B'], $A_2['id'], 'B',$plan_id);
                            echo $A2_2['data'] ?></td>
                        <td align="left"><?php $B1_1 = $this->plan_model->create_binary_tree($B_1['A'], $B_1['id'], 'A',$plan_id);
                            echo $B1_1['data'] ?></td>
                        <td align="right"><?php $B1_2 = $this->plan_model->create_binary_tree($B_1['B'], $B_1['id'], 'B',$plan_id);
                            echo $B1_2['data'] ?></td>
                        <td align="left"><?php $B2_1 = $this->plan_model->create_binary_tree($B_2['A'], $B_2['id'], 'A',$plan_id);
                            echo $B2_1['data'] ?></td>
                        <td align="right"><?php $B2_2 = $this->plan_model->create_binary_tree($B_2['B'], $B_2['id'], 'B',$plan_id);
                            echo $B2_2['data'] ?></td>
                    </tr>
                    </tbody>
                </table>
                                ...
                                <?php for ($y = 0; $y <= $l2_width-1; $y++) { ?>
                                    <?php if(strlen($l2_data[$y]->id)>2) { 
                                        ...
                                        <?php for ($z = 0; $z <= $l3_width-1; $z++) { ?>
                                            <td align="<?php if(fmod($z,2)==0){ echo 'center';} else{echo 'right';} ?>">
...
if($result->id != ''){
    $this->db->select('id, topup, status, signup_package')->where(array('position'=>$top_id, 'signup_package'=>$result->id));    
}else{
...
if($result->id != ''){
    $width = $top_id == config_item('top_id') ? $this->db_model->select('max_width', 'plans', array('id'=>$result->id)) : $width ;

$plan_id = $this->uri->segment('3') == '' ? $result->id : '';
$plan_name = $this->uri->segment('3') == '' ? $result->plan_name : '';    
} else{
    $plan_id = '';
    $plan_name = '';
}
...
<div class="row">
    <div class="col-sm-5">
        <table class="table">
            <tr>
                <td style="font-size: 12px" width="33.33%">
                    <img src="<?php echo base_url('uploads/site_img/green.png') ?>" class="img-circle img-fluid" width="50px"><br/>
                    Green User
                </td>
                <td style="font-size: 12px" width="33.33%">
                    <img src="<?php echo base_url('uploads/site_img/red.png') ?>" class="img-circle img-fluid"width="50px" ><br/>
                    Red User
                </td>
                <td style="font-size: 12px" width="33.33%">
                    <img src="<?php echo base_url('uploads/site_img/new.png') ?>" class="img-circle img-fluid"width="50px" ><br/>
                    No User
                </td>
            </tr>
        </table>
    ...
    <div class="col-sm-5">
        <form method="post" action="<?php echo site_url('tree/user_tree') ?>">
            <label>Enter User Id</label>
            <input type="text" name="top_id" class="form-control" value="<?php echo $top_id ?>">
            <button class="btn btn-xs btn-danger" type="submit">Search</button>
        </form>
    </div>
    <?php if(config_item('sep_tree')=='Yes') { ?>
    <div class="col-sm-5">
        <form method="post" action="<?php echo site_url('tree/user_tree') ?>">
            <select class="form-control" name="plan" required>
                <option value="<?php echo $plan_id ?>" selected> <?php echo $plan_name; ?> </option>
            <?php foreach ($plans as $val) {
                echo '<option value="' . $val['id'] . '">' . $val['plan_name'] . '</option>';
            } ?>
        </select>
...
<div class="row">
                ...
                <table align="center" class="table" style="max-width: 500px">
                    <tr>
                        <td colspan="3" class="alert alert-warning"> 
                            <?php $U = $this->plan_model->create_tree($top_id, '', 'A',$plan_id);
                            echo $U['data'] ?>
                        </td>
                    </tr>
                    <?php
                    ...
                    foreach ($data as $e) {
                        ...
                        $myimg = $e->photo ? base_url('uploads/profile/' . $e->photo) : base_url('uploads/site_img/' . $color . '.png');
                        echo '
                        <tr>
                            <td></td>
                            <td></td>
                            <td style="border-left: 4px dashed #006aeb;">
                                ...
                                <span style="text-align: center"> 
                                    <a href="' . site_url('tree/user_tree/' . $e->id). '" title="' . config_item('ID_EXT') . $e->id . '" style="text-decoration: none; color: ' . $color . '; margin: 5px" data-toggle="popover" data-trigger="hover" data-html="true" data-placement="top" data-content="' . "\n" . $total_node . '<br/>' . "\n\n" . '"><img class="img-circle" style="max-height: 70px" src="' . $myimg . '"><br/>' . $e->name . '<br/>(' . config_item('ID_EXT') . $e->id . ')
                                    </a>
                                </span> 
                            </td>
                        </tr>';
    ...
    <?php } elseif (($width == "3") && (count($member) <= $width)) {  ?>
        <div class="col-sm-12">
            <div class="table-responsive">
                <table class="table table-borderless">
                    <tbody>
                    <tr>
                        <td colspan="9" align="center"><?php $U = $this->plan_model->create_tree($top_id, '', 'A',$plan_id);
                            echo $U['data'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_bg.gif') ?>"
                                                        class="img-responsive">
                        </td>
                    </tr>
        ...
        <div class="col-sm-12">
            <div class="table-responsive">
                <table class="table table-borderless">
                    <tbody>
                    <tr>
                        <td colspan="16" align="center"><?php $U = $this->plan_model->create_tree($top_id, '', 'A',$plan_id);
                            echo $U['data'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_bg.gif') ?>"
                                                        class="img-responsive">
                        </td>
                    </tr>
    ...
    <?php } else if (($width == "5") && (count($member) <= $width)) { ?>
        <div class="col-sm-12">
            <div class="table-responsive">
                <table class="table table-borderless">
                    <tbody>
                    <tr>
                        <td colspan="20" align="center"><?php $U = $this->plan_model->create_tree($top_id, '', 'A',$plan_id);
                            echo $U['data'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_bg.gif') ?>"
                                                        class="img-responsive">
                        </td>
                    </tr>
    ...
    <?php } else { ?>
        <div class="hr_divider" style="text-align: center"><p>&nbsp;</p>
            <div class="table-responsive" style="overflow-x: auto; text-align: left" id='table'>
                <table align="center" class="table" style="max-width: 500px">
                    ...
                    <?php
                    if($plan_id >0){
                    $this->db->select('*')->where(array('position'=>$top_id, 'signup_package'=>$plan_id))->order_by(config_item('member_order_by'), 'ASC');
                    } else{
                        $this->db->select('*')->where(array('position'=>$top_id))->order_by(config_item('member_order_by'), 'ASC');
                    }
                    $data = $this->db->get('member')->result();
                    foreach ($data as $e) {
                        if ($e->status == 'Active') {
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                document.getElementById("sidebarmenu").setAttribute('style', 'height:' + table_height + 'px' + '!important');
                document.getElementById("pagecontent").setAttribute('style', 'height:' + table_height + 'px' + '!important');
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        document.querySelector("#utree > ul > li:nth-child(1) > a > span").setAttribute('style', 'color: darkorange !important;');
    });
</script>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        document.getElementById("pagecontent").setAttribute('style', 'height:' + mono_height + 'px' + '!important');
        document.getElementById("sidebarmenu").setAttribute('style', 'height:' + mono_height + 'px' + '!important');
