    ...
    <table class="table table-bordered" id="DTable" data-page-length='100' data-name="Pending_bank_payment_list" data-export='Yes'>
        ...
        foreach ($data as $e) {
            ...
            <tr>
                ...
                <td><a href="<?php echo site_url('income/approve_receipt/' . $e->id) ?>" class="btn btn-success btn-xs">Approve</a>
                    <a href="<?php echo site_url('income/reject_receipt/' . $e->id) ?>" class="btn btn-danger btn-xs">Reject</a>
               </td>
            </tr>
        <?php } ?>
        </tbody>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        document.querySelector("#deposit > ul > li:nth-child(4) > a > span").setAttribute('style', 'color: darkorange !important;');
    });
</script>