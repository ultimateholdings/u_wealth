        ...
        foreach ($members as $e) { ?>
            <tr>
                ...
                <!--    <?php if (config_item('enable_topup') == "Yes" && $e['topup'] <= 0) { ?>
                    ...
                    <?php } ?>-->
                    <a href="<?php echo site_url('users/activate/' . $e['id']); ?>" class="btn btn-success btn-xs">Activate</a>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        document.querySelector("#members > ul > li:nth-child(7) > a > span").setAttribute('style', 'color: darkorange !important;');
    });
</script>