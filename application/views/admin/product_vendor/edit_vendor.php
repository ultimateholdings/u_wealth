...
<div class="row">
    ...
    <div class="form-group col-sm-6"><!--if($data->join_time){ echo set_value('join_time', $data->join_time); } else{ echo "Joining time" ; }-->
            <label for="join_time" class="control-label">Date of Join</label>
            <input type="text" readonly class="form-control datepicker" value="<?php $dt = new DateTime($data->join_time); $date=$dt->format('Y-m-d'); echo $date;  ?>"
