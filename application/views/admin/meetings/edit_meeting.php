...
?>
<?php echo form_open('admin/update_meeting') ?>
<div class="row">
    <div class="col-sm-6">
    ...
    <div class="row">
        <div class="col-sm-12" style="margin-left:34px"><br/>
          
            <input type="submit" class="btn btn-success" value="Update" onclick="this.value='Updating..'">
            <a href="<?php echo site_url('/admin/manage_meetings');?>" id="cancel" name="cancel" class="btn btn-danger">Cancel</a>
        </div>
    </div>
