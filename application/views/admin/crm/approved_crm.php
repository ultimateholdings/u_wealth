        ...
        foreach ($members as $e) { ?>
            <tr>
               ...
               <td>
                ...
                <a href="<?php echo site_url('admin/edit_crm/' . $e['id']); ?>" class="btn btn-info btn-sm" style="margin-right: 10px;" >View/Edit</a>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        document.getElementById("crmpay").classList.add('active');
        document.querySelector("#crmpay > ul > li:nth-child(2) > a > span").setAttribute('style', 'color: darkorange !important;');
    });
</script>