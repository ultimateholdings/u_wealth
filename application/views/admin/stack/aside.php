...
<?php } ?>
   ...
   <div class="main-menu-content" >
      ...
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
         <br/>
         <li class=" navigation-header"><span>Hi, <?php echo $this->session->name ?></span><br/>
            <i class=" feather icon-minus" data-toggle="tooltip" data-placement="right" data-original-title="General" ></i>
         </li>
         <br/>
         <li class="nav-item active"><a href="<?php echo base_url('admin'); ?>"> <i class="fa fa-bank"></i><span class="menu-title" data-i18n="Dashboard" style="color:orange">Dashboard</span></a>
         </li>
         <?php if (!isset($this->session->designation)) { ?>
         <li id= 'plans' class="nav-item" >
            <a href="#" class="nav-link nav-toggle">
            <i class="fa fa-list"></i>
            <span class="title" style="color:orange;">Manage Plans</span>
         ...
         <?php if(config_item('enable_crm') == "Yes") { ?>
          <li id="crmpay" class="nav-item">
            ...
            <ul class="sub-menu">
               <li class="nav-item">
                  <a href="<?php echo site_url('admin/manage_crm') ?>"
                     class="nav-link ">
                  <span class="title">Manage</span>
                  </a>
               </li>
               <li class="nav-item">
                  <a href="<?php echo site_url('admin/approved_crm') ?>"
                     class="nav-link ">
                  <span class="title">Approved List</span>
                  </a>
               </li>
                <li class="nav-item">
                  <a href="<?php echo site_url('admin/rejected_crm') ?>"
                     class="nav-link ">
         ...
         <li class=" nav-item"><a href="<?php echo site_url('email'); ?>"><i class="fa fa-file-text-o"></i><span class="menu-title" data-i18n="Templates">Email</span></a>
                </li>
         <?php } ?>
