<?php 
$level = $this->db_model->select_multi('*', 'level_details', array('userid' => config_item('top_id'),'pid'=>1));
?>
...
<div class="container frame" style="width: 98%;">
	<p>
	<b>Dear Admin, </b>, Here is the level wise Member Report !!!</p>
	<p></p>
	<br>
