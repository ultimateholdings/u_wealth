...
$data   = $this->db_model->select_multi('*', 'member', array('id' => htmlentities($top_id)));
?>
<div class="row">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        document.querySelector("#utree > ul > li:nth-child(2) > a > span").setAttribute('style', 'color: darkorange !important;');
    });
</script>