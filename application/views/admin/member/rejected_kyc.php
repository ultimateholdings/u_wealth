...
<div class="table-responsive">
    <table class="table table-striped table-bordered" style="font-size:13px" id="DTable" data-page-length='100' data-name="rejected_kyc_list" data-export='Yes'>
        <thead>
        <tr>
            <th>SI NO</th>
            <th>User ID</th>
        ...
        foreach ($members as $e) { ?>
            <tr>
                ...
                <td><a href="<?php echo base_url('uploads/kyc/' . $e['cheque']); ?>"><img class="zoom" src="<?php echo $e['cheque'] ? base_url('uploads/kyc/' . $e['cheque']) : base_url('uploads/default.jpg'); ?>"
                         class="img-thumbnail img-responsive" style="max-height: 100px"></a>
                </td>
