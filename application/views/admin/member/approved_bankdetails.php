...
<div class="table-responsive">
    <table class="table table-striped table-bordered" style="font-size:13px" id="DTable" data-page-length='100' data-name="approved_bankdetils_list" data-export='Yes'>
        <thead>
        <tr>
            <th>SI NO</th>
            <th>User ID</th>
        ...
        <?php
        $sn = 1;
        foreach ($approved_bankdetails as $e) { ?>
            <tr>
                <td><?php echo $sn++; ?></td>
                ...
                <td><a href="#" class="btn btn-primary btn-sm"><?php echo $e['status']; ?></a></td>
