 var geocodingClient = mapboxSdk({accessToken: 'pk.eyJ1Ijoic293bXlha25zaGFybWEiLCJhIjoiY2tnbnFqbDk5MDlxNzMwczE4Zm16MGgzdiJ9.kipSLq1yQLlvI5kYuPQJUQ'});
    ...
    function autocompleteInputBox(inp) {
        ...
        inp.addEventListener("input", function (e) {
            ...
            autocompleteSuggestionMapBoxAPI($('#city').val(), function (results) {
    ...
    autocompleteInputBox(document.getElementById("city"));